...
(1, 3, 'nurquiza', 'noelia.urquiza@estimular.com', '$2b$10$fakedhash', 'Noelia Urquiza', '3813390033'),
(2, 3, 'igarcia', 'ivana.garcia@estimular.com', '$2b$10$fakedhash', 'Ivana Garcia', '3813679893'),
(3, 3, 'dnunez', 'daiana.nunez@estimular.com', '$2b$10$fakedhash', 'Daiana Nuñez', '3865560493'),
(4, 3, 'agonzalez', 'alejandra.gonzalez@estimular.com', '$2b$10$fakedhash', 'Alejandra Gonzalez', '3812235510'),
(5, 3, 'crodriguez', 'carla.rodriguez@estimular.com', '$2b$10$fakedhash', 'Carla Rodriguez', '3811112222'),
(6, 3, 'mfernandez', 'marcos.fernandez@estimular.com', '$2b$10$fakedhash', 'Marcos Fernandez', '3812223333'),
(7, 3, 'vlopez', 'valentina.lopez@estimular.com', '$2b$10$fakedhash', 'Valentina Lopez', '3813334444'),
(8, 3, 'jbustos', 'javier.bustos@estimular.com', '$2b$10$fakedhash', 'Javier Bustos', '3814445555'),
(9, 3, 'lmartinez', 'lucia.martinez@estimular.com', '$2b$10$fakedhash', 'Lucia Martinez', '3815556666'),
(10, 3, 'dcastillo', 'daniel.castillo@estimular.com', '$2b$10$fakedhash', 'Daniel Castillo', '3816667777'),
(11, 3, 'smorales', 'sofia.morales@estimular.com', '$2b$10$fakedhash', 'Sofia Morales', '3817778888'),
(12, 3, 'pnavarro', 'pablo.navarro@estimular.com', '$2b$10$fakedhash', 'Pablo Navarro', '3818889999'),
(13, 3, 'grios', 'gabriela.rios@estimular.com', '$2b$10$fakedhash', 'Gabriela Rios', '3819990000'),
(14, 3, 'fvega', 'facundo.vega@estimular.com', '$2b$10$fakedhash', 'Facundo Vega', '3810001111'),
(15, 3, 'cvera', 'camila.vera@estimular.com', '$2b$10$fakedhash', 'Camila Vera', '3811110000'),
(16, 3, 'mquiroga', 'martin.quiroga@estimular.com', '$2b$10$fakedhash', 'Martin Quiroga', '3812221111');
